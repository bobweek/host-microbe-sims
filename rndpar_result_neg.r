...
fnl = read.csv("dat/negNₑ/fnl_rndpar_dat.csv")
...
fnl = read.csv("dat/negS/fnl_rndpar_dat.csv")
...
fnl = read.csv("dat/negκ/fnl_rndpar_dat.csv")
...
ggsave("dneg.svg",dpl,width=12,height=12,bg='transparent')
ggsave("dneg.png",dpl,width=8,height=8)

#
# β
#

Sfnl = read.csv("dat/negS/fnl_rndpar_dat.csv")
Nfnl = read.csv("dat/negNₑ/fnl_rndpar_dat.csv")
κfnl = read.csv("dat/negκ/fnl_rndpar_dat.csv")
κℓfnl = read.csv("dat/negκℓ/fnl_rndpar_dat.csv")
